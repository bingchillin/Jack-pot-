...
class _CreateReplyModalState extends State<CreateReplyModal> with TickerProviderStateMixin {
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              widget.parentComment.person.firstname.isNotEmpty ? widget.parentComment.person.firstname : 'User',
                                              style: const TextStyle(
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600,
                                                color: Colors.black,
  ...
  Color _getCharacterCountColor() {
    ...
    if (length > 450) return Colors.red[600]!;
    if (length > 400) return Colors.orange[600]!;
