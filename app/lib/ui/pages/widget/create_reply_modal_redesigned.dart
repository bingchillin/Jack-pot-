...
class CreateReplyModalRedesigned extends StatefulWidget {
  final Comment parentComment;
  
  const CreateReplyModalRedesigned({
    super.key,
    required this.parentComment,
  });

  @override
  State<CreateReplyModalRedesigned> createState() => _CreateReplyModalRedesignedState();
}

class _CreateReplyModalRedesignedState extends State<CreateReplyModalRedesigned> with TickerProviderStateMixin {
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    'Replying to ${widget.parentComment.person.displayName}',
                                    style: TextStyle(
                                      color: Colors.grey[600],
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
