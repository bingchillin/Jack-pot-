...
class _PlantItemWidget extends State<PlantItemWidget> {
                            ...
                            onChanged: (value) async {
                              ...
                              try {
                                await ObjectProfileService().updateObjectProfile(
                                  id: plant.idObjectProfile.toString(),
                                  body: {"isAutomatic": value},
                                  token: token,
                                );
                              } catch (e) {
                                print('Erreur lors de la mise à jour AUTO: $e');
                              }
                            },
                          ...
                          Switch(
                            ...
                            onChanged: (value) async {
                              ...
                              try {
                                await ObjectProfileService().updateObjectProfile(
                                  id: plant.idObjectProfile.toString(),
                                  body: {"isWillWatering": value},
                                  token: token,
                                );
                              } catch (e) {
                                print('Erreur lors de la mise à jour ARROSER: $e');
                              }
                            },
