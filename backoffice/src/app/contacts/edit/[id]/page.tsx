        ...
        <Row gutter={16}>
          <Col span={6}>
            <div style={{ marginBottom: 16 }}>
              ...
              <div>{contact?.idContact}</div>
            </div>
          </Col>
          <Col span={6}>
            <div style={{ marginBottom: 16 }}>
              <Text type="secondary" style={{ fontSize: 12, display: "flex", alignItems: "center", gap: 4 }}>
                {getRoleIcon(contact?.role?.title)} Role
              </Text>
              <Tag color={contact?.role?.title?.toLowerCase() === 'admin' ? 'gold' : 'blue'}>
                {contact?.role?.title}
              </Tag>
            </div>
          </Col>
