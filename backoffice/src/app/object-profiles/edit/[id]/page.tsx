...
export default function ObjectprofileEdit({ params }: { params: { id: string } }) {
  ...
  const objectprofile = queryResult?.data?.data as BaseRecord;

  // Set initial values when data is loaded
  useEffect(() => {
    if (objectprofile) {
      formProps.form?.setFieldsValue({
        idObject: objectprofile.object?.idObject,
        idPlantType: objectprofile.plantType?.idPlantType
      });
    }
  }, [objectprofile, formProps.form]);
